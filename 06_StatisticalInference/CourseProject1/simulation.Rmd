...
output: pdf_document
---
Properties of the distribution of the mean of 40 random exponential distributions
========================================================
...
The theoretical sampling variance, or the variance of the sample mean, is equal to 1/ (n lambda^2) for a sample mean of n random draws from an exponential distribution with mean 1/lambda and variance 1/lambda^2.
